...
function GooFlow(bgDiv, property) {
    ...
    height = height;
    this.$bgDiv.append("<div class='GooFlow_work' style='width:" + (width - 20) + "px;height:" + (height) + "px;" + (property.haveHead ? "" : "margin-top:0px") + "'></div>");
...
GooFlow.prototype = {
    ...
    addNode: function (id, json) {
        ...
        if (json.type != "startround" && json.type != "endround") {
            ...
            if (!json.height || json.height < 24) json.height = 70;
